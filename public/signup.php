            ...
            <div class="col-4 mx-auto form-container p-3 gap-4">
                ...
                <form action="" method="POST" id="signup-form">
                    ...
                    <div class="form-floating mt-3">
                        <input name="email" type="email" class="form-control" id="floatingEmail" placeholder="" required>
                        <label for="floatingEmail">Email</label>
                    </div>
                    <div class="form-floating mt-3">
                        <input name="address" type="text" class="form-control" id="floatingAddress" placeholder="" required>
                    ...
                    <div class="form-floating mt-3">
                        <input name="passwordConfirm" type="password" class="form-control" id="floatingPasswordConfirm" placeholder="" required>
